  ...
  return (
    <section className="py-10 ">
            <div className="flex flex-col justify-center items-center">
                ...
                <p className="font-medium text-lg text-center mx-2 max-w-[600px] my-4">Boost your educational portfolio with Learn X today and get the knowledge your need to 
                    make more money
                </p>
                <div className="flex gap-10 py-5 my-2">
