    ...
    <section>
        <div name="home" className="bg-hero-image bg-cover bg-no-repeat bg-center w-full h-[600px] items-center justify-center">
            <div className="text-center">
                ...
                <p className="mt-10 text-white text-center  text-3xl md:text-4xl lg:6xl font-extrabold">Experience World-Class Education from industry experts. Gain the skills you need to succed</p>
            </div>
