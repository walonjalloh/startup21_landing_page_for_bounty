...
function Products() {
  return (
    <section name='services' className="flex flex-col justify-center items-center py-24">
        <div className="text-center text-[15px] bg-gradient-to-r from-red-400 to-blue-500 bg-clip-text text-transparent border border-black/50 px-2 rounded hover:scale-125">Eductate Your Future</div>
