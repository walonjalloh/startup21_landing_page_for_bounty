...
function Products() {
  return (
    <section name='services' className="flex flex-col justify-center items-center py-24">
        ...
        <p className="text-center text-xl font-thin my-6 mx-auto md:max-w-[500px]">Use our system to get a better education in programming, web development, blockchain technology
