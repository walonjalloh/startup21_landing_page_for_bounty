    ...
    <section name='contact' className="py-24"> 
        {open && (
             ...
             <form className="flex flex-col justify-start items-center my-10">
                 ...
                 <input  className='w-[400px] my-2 border border-black rounded-md' type="text" name="name" placeholder="Name"/>
                 <label className="text-2xl font-md">Email</label>
                 <input className="border border-black rounded-md w-[400px] my-2" type="email" name='email' placeholder="Email"/>
